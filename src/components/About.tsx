    ...
    <section id="about" className="py-20 bg-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <svg className="absolute inset-0 w-full h-full opacity-20" style={{ zIndex: 1 }}>
          <defs>
            <linearGradient id="constellation-gradient-about" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <line x1="15%" y1="25%" x2="30%" y2="20%" stroke="url(#constellation-gradient-about)" strokeWidth="1" className="animate-constellation-draw" />
          <line x1="30%" y1="20%" x2="40%" y2="35%" stroke="url(#constellation-gradient-about)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '0.5s' }} />
          <line x1="40%" y1="35%" x2="25%" y2="45%" stroke="url(#constellation-gradient-about)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '1s' }} />
          
          <line x1="65%" y1="15%" x2="80%" y2="30%" stroke="url(#constellation-gradient-about)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '1.5s' }} />
          <line x1="80%" y1="30%" x2="85%" y2="45%" stroke="url(#constellation-gradient-about)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '2s' }} />
          <line x1="85%" y1="45%" x2="70%" y2="55%" stroke="url(#constellation-gradient-about)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '2.5s' }} />
        </svg>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              {infoCards.map((card, index) => (
                <div
                  key={index}
                  className={`group relative p-6 bg-white/10 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-2xl ${card.glowColor} transform hover:scale-105 transition-all duration-500 border border-white/20 overflow-hidden`}
