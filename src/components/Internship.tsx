    ...
    <section id="internship" className="py-20 bg-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-orange-500/6 rounded-full blur-3xl animate-pulse delay-2000"></div>
        </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 mb-12 hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {internshipData.skills.map((skill, index) => (
                      <span
                        key={index}
                        className="px-3 py-1 bg-gradient-to-r from-orange-500/20 to-orange-600/20 border border-orange-500/30 rounded-full text-orange-400 text-sm font-medium hover:from-orange-500/30 hover:to-orange-600/30 transition-colors duration-300"
                      >
                        {skill}
                      </span>
                    ))}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {internshipData.expectations.map((expectation, index) => (
              <div
                key={index}
                className="group bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:shadow-2xl transition-all duration-500 transform hover:scale-105"
              >
