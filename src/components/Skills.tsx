    ...
    <section id="skills" className="py-20 bg-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        {twinklingStars.map((star) => (
          <div
            key={`skills-twinkling-star-${star.id}`}
        ...
        <svg className="absolute inset-0 w-full h-full opacity-20" style={{ zIndex: 1 }}>
          <defs>
            <linearGradient id="skills-constellation-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <line x1="15%" y1="25%" x2="30%" y2="20%" stroke="url(#skills-constellation-gradient)" strokeWidth="1" className="animate-constellation-draw" />
          <line x1="30%" y1="20%" x2="40%" y2="35%" stroke="url(#skills-constellation-gradient)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '0.5s' }} />
          <line x1="40%" y1="35%" x2="25%" y2="45%" stroke="url(#skills-constellation-gradient)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '1s' }} />
          
          <line x1="65%" y1="15%" x2="80%" y2="30%" stroke="url(#skills-constellation-gradient)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '1.5s' }} />
          <line x1="80%" y1="30%" x2="85%" y2="45%" stroke="url(#skills-constellation-gradient)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '2s' }} />
          <line x1="85%" y1="45%" x2="70%" y2="55%" stroke="url(#skills-constellation-gradient)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '2.5s' }} />
        </svg>
              ...
              >
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 overflow-hidden rounded-2xl">
                  ...
                  {[...Array(4)].map((_, i) => (
                    <div
                      key={`code-${i}`}
                      className="absolute code-symbol text-white/10 text-2xl font-mono"
                      style={{
                        right: `${5 + (i * 8)}%`,
                        bottom: `${10 + (i * 15)}%`,
                  ...
                  {[...Array(3)].map((_, i) => (
                    <div
                      key={`pulse-${i}`}
                      className="absolute pulse-circle rounded-full border-2 border-white/10"
                      style={{
                        left: `${20 + (i * 25)}%`,
                        top: `${30 + (i * 20)}%`,
                        width: `${20 + (i * 10)}px`,
