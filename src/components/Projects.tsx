    ...
    <section id="projects" className="py-20 bg-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        {twinklingStars.map((star) => (
          <div
            key={`projects-twinkling-star-${star.id}`}
        ...
        <svg className="absolute inset-0 w-full h-full opacity-20" style={{ zIndex: 1 }}>
          <defs>
            <linearGradient id="projects-constellation-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <line x1="15%" y1="25%" x2="30%" y2="20%" stroke="url(#projects-constellation-gradient)" strokeWidth="1" className="animate-constellation-draw" />
          <line x1="30%" y1="20%" x2="40%" y2="35%" stroke="url(#projects-constellation-gradient)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '0.5s' }} />
          <line x1="40%" y1="35%" x2="25%" y2="45%" stroke="url(#projects-constellation-gradient)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '1s' }} />
          
          <line x1="65%" y1="15%" x2="80%" y2="30%" stroke="url(#projects-constellation-gradient)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '1.5s' }} />
          <line x1="80%" y1="30%" x2="85%" y2="45%" stroke="url(#projects-constellation-gradient)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '2s' }} />
          <line x1="85%" y1="45%" x2="70%" y2="55%" stroke="url(#projects-constellation-gradient)" strokeWidth="1" className="animate-constellation-draw" style={{ animationDelay: '2.5s' }} />
        </svg>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="group relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl overflow-hidden"
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech, techIndex) => (
                        <span
                          key={techIndex}
                          className={`px-3 py-1 bg-gradient-to-r ${project.color} bg-opacity-20 border border-current border-opacity-30 rounded-full text-xs font-medium text-white hover:bg-opacity-30 transition-colors duration-300`}
                        >
                          {tech}
                        </span>
                      ))}
                  ...
                  <div className="flex space-x-4">
                    ...
                    <button className="flex items-center justify-center px-4 py-3 bg-white/10 hover:bg-white/20 text-white rounded-lg transition-colors duration-300">
